...
public class ModBlocks
{
    ...
    public static final DeferredRegister<Block> BLOCKS =
        DeferredRegister.create(Registries.BLOCK, ShanMod.MODID);
    ...
    // 在这里添加更多方块...
    // public static final DeferredHolder<Block, Block> YOUR_BLOCK = BLOCKS.register("your_block", YourBlock::new);
}
